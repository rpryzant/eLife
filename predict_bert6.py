# now we're predicting from reviews
# switch to less memory hungry model? 
...
def get_raw_data(people, papers):
    ...
    for pid, paper_info in papers:
        ...
        neutral = paper_info["neutral_reviewers"]

        for review in paper_info['reviews']:
            text = review['text']
            outcome = review['outcome']
            author = review['author']

            if author in neutral:  
                continue
...
train_inputs, test_inputs, train_labels, test_labels, train_masks, test_masks, = train_test_split(
    data['input_ids'], data['labels'], data['attn_masks'],
